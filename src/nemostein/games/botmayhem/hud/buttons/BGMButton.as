package nemostein.games.botmayhem.hud.buttons
{
	...
	import nemostein.games.botmayhem.assets.hud.AssetSfxButtonDown;
	import nemostein.games.botmayhem.assets.hud.AssetSfxButtonUp;
	
	public class BGMButton extends Button
	{
		...
		override protected function initialize():void
		{
			...
			_releasedAsset = new Core(Bitmap(new AssetSfxButtonUp).bitmapData);
			_pressedAsset = new Core(Bitmap(new AssetSfxButtonDown).bitmapData);
